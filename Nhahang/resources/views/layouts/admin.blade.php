            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#"
                        ...
                        <img src="https://ui-avatars.com/api/?name=Guest" alt="Profile" class="rounded-circle">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        <li class="dropdown-header">
                            ...
                            <li class="nav-item pe-3">
                                <a style="margin-left: 45%; " class="nav-link" href="{{ route('login') }}">{{ __('Login') }}</a>
                            </li>
                            @endif

                            @if (Route::has('register'))
                                <li class="nav-item pe-5">
                                    <a  style="margin-left: 45%; " class="nav-link" href="{{ route('register') }}">{{ __('Register') }}</a>
                                </li>
                            @endif
                        @else
                        <li>
                      ...
                      <li>
                          <a class="dropdown-item d-flex align-items-center" href="#">
                              <span><a style="margin-left: 45%; color: black;" href="{{ route('logout') }}"
